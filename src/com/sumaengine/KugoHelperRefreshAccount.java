...
public class KugoHelperRefreshAccount extends TimerTask {
	
	static DbmysqlLayer mysqlDBLayer1;
	public static int counterRun = 1;
	static Logger log = Logger.getLogger(KugoHelperRefreshAccount.class.getName());
    ...
    {
		log.info("-");
		log.info("Timer Task for Refresh Account started.. ["+ counterRun + "]");
		...
		try 
		{
	        ...
	        /*
	         * Algoritma:
	         * 1. cari record2 yang refresh Account dan command type = 41 dan status nya = 0 
	         */
	        ...
	        if (!rs.next()) {
	        	...
	        	//log.info("");
	        	log.info( "NO RECORDS - Refresh Account TO PROCESS.." );	        	
	        	...
	        	do  {
	        		...
	        		/*
	            	 * Algoritma:
	            	 * 2. proses recod-record untuk Refresh account.
	            	...
	            	/*
	            	 * step 2.1 : process Refresh account to SUMA 
	            	 */
	            	...
	            	try {
	            		 ...
	            		 * Querynya adalah tbl ref = refresh account & command type = 43
	            		 * 
	            		 */
	            		...
	            		if (sumaresponse.getResponseStatus() == "1") {
	            			...
	            			String recordQueryAuth = "SELECT * FROM reg_srv_up_kugo \n"
	            					+"WHERE tbl_ref = 'refresh account' \n"
	            					+"AND command_type = 43 AND status_send = '0' \n"
	            			...
	            			if (!rsOpenAuth.next()) {
	            				 ...
	            				 */
	            				log.info("Found records to Refresh openAuth for VC: "+ sr1.getViewcardNo());
	            				do {
	            	            	...
	            	            	// Open Auth 
	            	            	log.info("Open Re-Auth process to SUMA Server..");
		...
		log.info("Task Open Refresh Account thread sleep for 5 seconds..");		
		log.info("-");
		counterRun++;
